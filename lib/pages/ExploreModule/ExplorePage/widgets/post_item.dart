  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        context.push('${AppRoutes.explorePage}/${AppRoutes.postDetailView}',
            extra: postModel);
      },
      child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Text(
                                PostCategoryEnum
                                    .values[postModel.postCategoryEnum!].isim,
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                            Utils.formatDateToDayMonthYear(
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                                TurkeyProvince.getCityNameByPlateCode(
                                    postModel.illerEnum!),
                                style: Theme.of(context).textTheme.labelSmall),
                          ],
                        )
