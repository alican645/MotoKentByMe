...
import 'package:moto_kent/pages/CallForHelpModule/CallForHelpPage/widgets/call_for_help_view_item.dart';
import 'package:moto_kent/pages/CallForHelpModule/CallForHelpPage/widgets/call_for_help_view_item_progress_indicator.dart';
...
class _CallForHelpViewState extends State<CallForHelpView> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Fluttertoast.showToast(
            msg: "Yardım çağırınız yakınınızda bulunan $count kişiye iletildi");
      }
    } catch (ex) {
  ...
  void showMessage(CallForHelpEnum callForEnum) {
    showDialog(
      context: context,
      builder: (contextt) => AlertDialog(
        content: const SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                "Diğer kullanıcılara yardım çağrısında bulunuyorsunuz!!!",
              ...
              children: [
                ...
                value.isLoadingSY
                    ? CallForHelpViewItem(
                        ...
                        onPressed: () async {
                          showMessage(CallForHelpEnum.sorunYardim);
                        },
                      )
                ...
                value.isLoadingKY
                    ? CallForHelpViewItem(
                        ...
                        onPressed: () async {
                          showMessage(CallForHelpEnum.kazaYardim);
                        },
                      )
                    : const CallForHelpViewItemProgressIndicator(),
                const SizedBox(
                ...
                value.isLoadingBB
                    ? CallForHelpViewItem(
                        ...
                        onPressed: () async {
                          showMessage(CallForHelpEnum.beniBul);
                        },
                      )
                    : const CallForHelpViewItemProgressIndicator(),
                const SizedBox(
