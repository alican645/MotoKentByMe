...
class OptionsWidget extends StatefulWidget {
  ...
  required this.goJoinGroupRequestPage
  });
  ...
  final VoidCallback? goJoinGroupRequestPage;
  @override
  State<OptionsWidget> createState() => _OptionsWidgetState();
}

class _OptionsWidgetState extends State<OptionsWidget> {
  static const MenuItem _joinGroupsRequests= MenuItem(text: "İstekleri Gör", icon: Icons.remove_red_eye);
  ...
  void initState() {
    ...
    widget.amIAdmin?itemList.add(_joinGroupsRequests):null;
  }
        ...
        onChanged: (item) async {
          switch (item) {
            ...
            case _leave || _delete:
              widget.onLeaveGroup!();
              break;
            case _joinGroupsRequests:
              widget.goJoinGroupRequestPage!();
              break;
          }
        },
