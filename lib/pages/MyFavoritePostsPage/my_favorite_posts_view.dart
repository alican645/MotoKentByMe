...
class MyFavoritePostsView extends StatefulWidget {
  const MyFavoritePostsView({super.key});

  @override
  State<MyFavoritePostsView> createState() => _MyFavoritePostsViewState();
}

class _MyFavoritePostsViewState extends State<MyFavoritePostsView> {
  ...
  void initState(){
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await context.read<MyFavoritePostsViewmodel>().fetchFavoritePostList();
    },);
