...
import 'package:moto_kent/pages/MyNotificationsPage/widgets/notification_item.dart';
...
class _MyNotificationsViewState extends State<MyNotificationsView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) {
        ...
        context.read<LoginViewmodel>().set0NotificationCount();
      },
    );
  }
  ...
  Future<void> acceptUser(
      NotificationModel notificationModel, BuildContext context) async {
